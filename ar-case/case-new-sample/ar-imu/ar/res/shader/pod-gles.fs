...
vec3 calculateDirectionalLight(DirectionalLight light, vec3 ambientNature, vec3 diffuseNature, vec3 specularNature) {
    ...
    light.base.color * 0.9;
    
    return out_color;
}


vec3 calculateDirectionalLight2(DirectionalLight light, vec3 ambientNature, vec3 diffuseNature, vec3 specularNature) {
    //calculate ambient light
    float ambient = light.base.lightWeight.ambientStrength;
    vec3 ambientColor = 0.1 * ambientNature;
    ...
    //sum all
    vec3 out_color = (ambientColor + diffuseColor + specularColor) *
    light.base.color * 0.6;
    
    return out_color;
}

vec3 calculateDirectionalLight3(DirectionalLight light, vec3 ambientNature, vec3 diffuseNature, vec3 specularNature) {
    //calculate ambient light
    float ambient = light.base.lightWeight.ambientStrength;
    vec3 ambientColor = 0.1 * ambientNature;
    ...
    //sum all
    vec3 out_color = (ambientColor + diffuseColor + specularColor) *
    light.base.color * 0.1;
    
    return out_color;
}

vec3 calculateDirectionalLight4(DirectionalLight light, vec3 ambientNature, vec3 diffuseNature, vec3 specularNature) {
    //calculate ambient light
    float ambient = light.base.lightWeight.ambientStrength;
    vec3 ambientColor = 0.1 * ambientNature;
...
vec3 calculateDirectionalLight5(DirectionalLight light, vec3 ambientNature, vec3 diffuseNature, vec3 specularNature) {
    //calculate ambient light
    float ambient = light.base.lightWeight.ambientStrength;
    vec3 ambientColor = 0.1 * ambientNature;
...
void main() {
    if ((directionalLightCount + pointLightCount + spotLightCount) > 0) {
        ...
        output_color += calculateDirectionalLight(directionalLight[0], diffuseNature, diffuseNature, specularNature);
        output_color += calculateDirectionalLight2(directionalLight[0], diffuseNature, diffuseNature, specularNature);
        output_color += calculateDirectionalLight3(directionalLight[0], diffuseNature, diffuseNature, specularNature);
        output_color += calculateDirectionalLight4(directionalLight[0], diffuseNature, diffuseNature, specularNature);
        output_color += calculateDirectionalLight5(directionalLight[0], diffuseNature, diffuseNature, specularNature);
        
        gl_FragColor = vec4(vec3(output_color), lucency);
    } else {
        gl_FragColor = texture2D(sTexture, object_texcoord);
    }
}
