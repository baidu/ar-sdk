...
extern const GLfloat kColorConversionBT601[];
extern const GLfloat kColorConversionBT601FullRange[];
extern const GLfloat kColorConversionBT709[];
extern NSString *const kBARImageYUVVideoRangeConversionForRGFragmentShaderString;
extern NSString *const kBARImageYUVFullRangeConversionForLAFragmentShaderString;
extern NSString *const kBARImageYUVVideoRangeConversionForLAFragmentShaderString;


//Delegate Protocal for Face Detection.
@protocol BARImageVideoCameraDelegate <NSObject>
...
/**
 A BARImageOutput that provides frames from either camera
*/
@interface BARImageVideoCamera : BARImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
...
@property(nonatomic, assign) id<BARImageVideoCameraDelegate> delegate;
